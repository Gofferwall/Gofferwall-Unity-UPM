...
namespace Gofferwall.Editor
{
    /// <summary>
    /// Generates AndroidManifest.xml file based on the Ad network setting
    /// used by Unity Editor Menu Extention for GofferwallSdk
    ...
    public class ManifestHandler
    {
        ...
        private const string XML_ATT_THEME = "theme";
        ...
        public ManifestHandler(string packageName)
        {
            ...
            new XAttribute(ns + XML_ATT_THEME, "@style/Theme.AppCompat.NoActionBar"));
